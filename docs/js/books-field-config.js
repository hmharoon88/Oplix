...
(function () {
    ...
    const BOOKS_FIELDS = [
        ...
        { id: "pulltabs", label: "Pulltab", group: "daily", defaultCategory: "sales" },
        { id: "windStations", label: "Wind station", group: "daily", defaultCategory: "sales" },
        { id: "kenoStations", label: "Keno station", group: "daily", defaultCategory: "sales" },
        { id: "lottery", label: "Lottery", group: "daily", defaultCategory: "sales" },
