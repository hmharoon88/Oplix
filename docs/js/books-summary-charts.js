...
(function () {
    ...
    function renderKeyMetricsPanel(agg, options) {
        ...
        const rows = [
            ...
            keyMetricCell("Checks Received", money(agg.receivablesTotal), opt),
        ...
        const trackRows = [
            ...
            ...(M.num(agg.inHouseAccount)
                ? [keyMetricCell("In house (track)", money(agg.inHouseAccount), opt)]
                : []),
    ...
    function historyDetailColumns(packs, booksModel) {
        ...
        cols.push(
            ...
            { label: "Checks Received", get: (a) => a.receivablesTotal },
